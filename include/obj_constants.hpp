...
constexpr float TRIANGULE_CENTER_Z = TABLE_CENTER_Z - TABLE_LENGTH/3 + TRIANGULE_OFFSET_Z;

constexpr float WHITE_BALL_X = TRIANGULE_CENTER_X;
constexpr float WHITE_BALL_Z = TABLE_CENTER_Z + TABLE_LENGTH/3 - TRIANGULE_OFFSET_Z;
